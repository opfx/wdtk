...
import { Arguments, Option, OptionType } from './types';
...
describe('parseArguments', () => {
  const options: Option[] = [
    ...
    { name: 't3', aliases: [], type: OptionType.Number, types: [OptionType.Number, OptionType.Any], description: '' },
  ...
  const tests: { [test: string]: Partial<Arguments> | ['!!!', Partial<Arguments>, string[]] } = {
    ...
    '--bool val1 --etc --num=1 val2 --v': { bool: true, num: 1, p1: 'val1', p2: 'val2', '--': ['--etc', '--v'] },
    '--arr=a d': { arr: ['a'], p1: 'd' },
